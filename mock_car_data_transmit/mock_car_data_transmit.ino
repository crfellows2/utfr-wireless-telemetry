...
#define CAN_TX_PIN    GPIO_NUM_18   // Change to your TX pin
#define CAN_RX_PIN    GPIO_NUM_19   // Change to your RX pin
...
void loop() {
    ...
    // Serial output
    Serial.print("Accel (g) X:"); Serial.print(imu.data.accelX, 3);
    Serial.print(" Y:");          Serial.print(imu.data.accelY, 3);
    Serial.print(" Z:");          Serial.print(imu.data.accelZ, 3);
    Serial.print("  Gyro (deg/s) X:"); Serial.print(imu.data.gyroX, 3);
